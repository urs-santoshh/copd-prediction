...
duration_of_smoking = st.number_input(
    "Duration_Of_Smoking", min_value=0, max_value=80, value=0)
...
location = st.selectbox("Location", ["Butwal", "Chitwan", "Dharan", "Hetauda", "Kathmandu",
