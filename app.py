...
expected_columns = [
    "Age","Duration_Of_Smoking", "Biomass_Fuel_Exposure", "Occupational_Exposure", "Family_History_COPD",
    "BMI", "Air_Pollution_Level", "Respiratory_Infections_Childhood", "Pollution_Risk_Score",
    "Smoking_Status_encoded", "Gender", "Smoking_Pollution_Interaction",
...
location = st.selectbox(
    "Location",
    ["Butwal", "Chitwan", "Dharan", "Hetauda", "Kathmandu",
